...
public class Assessment implements Serializable {
  ...
  Assessment(Long id, String code, String name, String surname, String email,
      String phone, String topic, Float swl1, Float swl2, Float swl, Float ds1,
  ...
  /**
   * @param assessment
   *          — Assessment to be stored Method relies on properly initialized
   *          ModelManager.initModelDataManager(...) N.B. method adds new entry
   *          if id is not set or merges with existing, if id is set
   */

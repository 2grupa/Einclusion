...
public class ModelManager implements Serializable {
  ...
  /**
   * All model manager related settings and intermediate data are stored in Key:
   * Value pairs in ModelManager table
   */
  @Id
  ...
  /**
   * For better debugging values are stored as Strings If Object structure needs
   * to be stored it is serialized as JSON using set/getObjectValue methods
   */

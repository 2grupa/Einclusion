...
public class RegressionModel {
	...
	public RegressionModel(String key, String coefficients, int method2) {
	 ...
	 */
	public static float getM2regressionDegree(RegressionModel rm, float SWL, float SAL, float ELM, float IWS, float ELE) {
		float result = 0;
